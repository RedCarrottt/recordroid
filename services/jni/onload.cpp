...
extern "C" jint JNI_OnLoad(JavaVM* vm, void* reserved)
{
	...
	// Recordroid patch
	register_android_server_recordroid_KernelInputEventPoller(env);
	register_android_server_recordroid_EventReplayer(env);
	register_android_server_recordroid_RecordroidTimer(env);
