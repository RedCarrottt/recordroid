...
import com.android.server.recordroid.RecordroidService;
...
class ServerThread {
    ...
    public void initAndLoop() {
        ...
        if (factoryTest != SystemServer.FACTORY_TEST_LOW_LEVEL) {
			// Recordroid Patch: start Recordroid service
			try {
				Slog.i(TAG, "Recordroid Service");
				ServiceManager.addService("Recordroid", new RecordroidService(context));
			} catch(Throwable e) {
				Slog.e(TAG, "Failure starting Recordroid Service", e);
			}
            if (!disableStorage &&
